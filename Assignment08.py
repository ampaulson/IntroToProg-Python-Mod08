...
# APaulson,6.7.20,Modified code to complete assignment 8
# ------------------------------------------------------------------------ #
    ...
    def read_data_from_file(file_name):
        ...
        try:
            ...
            print('\nWelcome to the Product List. \n'
                  'You must be new here, I have no data to read to you --\n')
            return []
...
class IO:
    ...
    def input_new_product_data():
        ...
        price = input('And Please Enter Product Price: ')
        if price == '':
...
while (True):
    ...
    # let user save current data to file and exit program
        ...
        print("Your list has been saved. Thank you!")
        break  # Exit Program
